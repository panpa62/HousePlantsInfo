const plantCareApi = {
  data: [
    ...
    },
    {
      ...
      scientific_name: ["Citrus reticulata 'Clementine'"],
      section: [
        {
          id: 17,
          type: "watering",
          description:
            "Generally, mandarin orange trees need about one inch of water per week, ideally spread out over several waterings. This can be measured with a rain gauge or by a general estimation of the time needed to water the tree.\n\nIn the summer, mandarin orange trees typically require more frequent and deeper watering, as the weather tends to be hotter and drier. For healthy tree growth and production, watering should be done every two weeks, when the soil becomes dry to the touch.",
        },
        {
          id: 19,
          type: "pruning",
    ...
    },
    {
      ...
      scientific_name: ["Citrus sinensis 'Trovita'"],
      section: [
        {
          id: 21,
          type: "watering",
          description:
            "Water your navel orange tree (Citrus sinensis 'Trovita') 2 to 3 times a week in the summer, in the first year of planting, and once a week in the winter. During the first 2 years, water the tree deeply once per week to saturate the soil.\n\nAfter the tree is established, reduce the frequency of watering to once every 2 weeks, allowing for a deep but thorough watering. During periods of drought, water the tree more often, but not more than once every 3 days. It is important to water the orange tree deeply, but not too frequently.\n\nIn general, navel orange trees require about 10 to 15 gallons of water a week in moist to wet conditions and up to 25 gallons in periods of drought.",
        },
        {
          id: 22,
          type: "sunlight",
    ...
    },
    {
      ...
      species_id: 1896,
      common_name: "navel orange",
      scientific_name: ["Citrus sinensis 'Washington'"],
      section: [
        {
          id: 25,
          type: "watering",
    ...
    },
    {
      id: 9,
      species_id: 921,
      common_name: "common bearberry",
      scientific_name: ["Arctostaphylos uva-ursi 'Big Bear'"],
      section: [
        {
          id: 33,
          type: "watering",
    ...
    },
    {
      ...
      scientific_name: ["Capsicum annuum 'Bananarama'"],
      section: [
        {
          id: 37,
          type: "watering",
    ...
    },
    {
      ...
      scientific_name: ["Clematis 'Silver Moon'"],
      section: [
        {
          id: 130,
          type: "watering",
...
// const data1 = plantCareApi.data;
// //console.log(data1.length);
// for (let i = 0; i < data1.length; i++) {
//   console.log(data1[i].common_name);
//   console.log(i);
// }
module.exports = plantCareApi;
